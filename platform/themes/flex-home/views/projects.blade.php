            ...
            <div class="projecthome">
                <div class="row rowm10">
                    <div class="col-md-3 col-sm-6">
                        {!! Theme::partial('search-box', ['type' => 'project', 'categories' => $categories]) !!}
                    </div>
                                            ...
                                            far
                                             fa-heart"></i></a>--}}
                                                <a href="{{ $project->url }}"><h5>{{ $project->name }}</h5>
                                                    <p class="dia_chi"><i class="fas fa-map-marker-alt"></i> {{$project->location}} {{ $project->city->name }}, {{ $project->city->state->name }}</p>
