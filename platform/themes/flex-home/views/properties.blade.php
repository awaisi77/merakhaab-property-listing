                                        ...
                                        far
                                         fa-heart"></i></a>--}}
                                            <a href="{{ $property->url }}"><h5>{{ $property->name }}</h5>
                                                <p class="dia_chi"><i class="fas fa-map-marker-alt"></i> {{ $property->location }}, {{ $property->city->name }}, {{ $property->city->state->name }}</p> {{--,{{substr($property->location,0,10)}}--}}
                                                <p class="bold500">{{ __('Price') }}: {{ format_price($property->price, $property->currency) }}  - <i class="fa fa-eye"></i> {{$property->views}}</p>
                                            </a>
                                            <p class="threemt bold500">
                                                ...
                                                @endif
                                                @if ($property->square)
                                                    <span data-toggle="tooltip" data-placement="top" data-original-title="{{ __('Square') }}"> <i><img src="{{ Theme::asset()->url('images/area.svg') }}" alt="icon"></i> <i class="vti">{{ $property->square }} {{$property->size_type }}</i> </span>
                                                @endif
