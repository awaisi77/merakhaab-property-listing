    ...
    $('.select-city-state').on('keydown', function () {
      ...
      if (k) {
        ...
        locationTimeout = setTimeout(function () {
          $.get('/ajax/cities?k=' + k, function (data) {
            if (!data.error && data.data !== '') {
...
module.exports = __webpack_require__(/*! D:\xampp\htdocs\merakhaab\platform\themes\flex-home\assets\js\app.js */"./platform/themes/flex-home/assets/js/app.js");
