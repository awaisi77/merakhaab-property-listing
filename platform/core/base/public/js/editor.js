    ...
    value: function manageShortCode() {
      ...
      $('.add_short_code_btn').on('click', function (event) {
        ...
        if ($('.editor-ckeditor').length > 0) {
          ...
          tinymce.get($('.add_shortcode_btn_trigger').data('result')).execCommand('mceInsertContent', false, '<div>[' + $shortCodeKey.val() + attributes + ']' + content + '[/' + $shortCodeKey.val() + ']</div>');
        }
...
module.exports = __webpack_require__(/*! D:\xampp\htdocs\merakhaab\platform\core\base\resources\assets\js\editor.js */"./platform/core/base/resources/assets/js/editor.js");
