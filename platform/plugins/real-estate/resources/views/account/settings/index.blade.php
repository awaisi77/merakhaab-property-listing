                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 order-lg-0">
                        ...
                        <!-- Name -->
                            ...
                            <div class="form-group">
                                <label for="country">{{ trans('plugins/real-estate::dashboard.country') }}</label>
                                ...
                                <select
                                    ...
                                    @foreach($countries = \Botble\Location\Models\Country::all() as $country)
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="user_city" value="{{ $user->city_id }}" >
                                <select
                                    required
                                    class="form-control"
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each(result, function (key, value) {
                        let selected = (user_city == value.id)? "selected":"";
